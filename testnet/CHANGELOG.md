...
* `AggressorSide (2446)` is now rendered in the [FIX Market Data Trade Stream](https://github.com/BitDJ/notebook/blob/fix_md/api_documentation/dotcom/testnet/fix-api.md#tradestream). The QuickFix schema [file](https://github.com/binance/binance-spot-api-docs/blob/master/fix/schemas/spot-fix-md.xml) has also been updated. Please download the latest schema before the Spot Testnet upgrade is completed.
